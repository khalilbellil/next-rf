    ...
    return (
        <div className="container pt-3 pb-5 rf-content">
            <div id="texte_a_afficher" class="texte_inselectionnable">
                ...
                <p ><strong><span id="span_id_nom_du_site">de RenovationFacile.fr</span> </strong></p>
                <br/>
                <p ><strong>ARTICLE 1&nbsp;: PRÉAMBULE<br/></strong></p>
                <p>Cette politique de confidentialité s'applique au site&nbsp;: <span id="span_id_nom_du_site">RenovationFacile.fr</span>. <br/></p>
                ...
                <p ><span id="span_id_url_cgu">Renovationfacile.fr/conditions-generales-d-utilisation</span></p>
                <p ><span ><br/></span><strong>ARTICLE 2&nbsp;: PRINCIPES GÉNÉRAUX EN MATIÈRE DE COLLECTE ET DE TRAITEMENT DE DONNÉES</strong><br/></p>
                ...
                <ul>
                <li>Intégrité et confidentialité des données collectées et traitées&nbsp;: le responsable du traitement des données s'engage à garantir l'intégrité et la confidentialité des données collectées.<br/></li>
                </ul>
                ...
                <p ><br/><strong>ARTICLE 3&nbsp;: DONNÉES À CARACTÈRE PERSONNEL COLLECTÉES ET TRAITÉES DANS LE CADRE DE LA NAVIGATION SUR LE SITE<br/></strong></p>
                <p ><strong>A. </strong>DONNÉES COLLECTÉES ET TRAITÉES ET MODE DE COLLECTE</p>
                <p>Les données à caractère personnel collectées sur le site <span id="span_id_nom_du_site_internet">Renovation Facile</span> sont les suivantes&nbsp;:</p>
                <p ><span id="span_id_liste_donnees_collectees">- Prénoms, nom&nbsp;;<br/>- Adresse e-mail&nbsp;;<br/>- Adresse postale&nbsp;;<br/>- Numéro de téléphone&nbsp;;<br/>- Coordonnées bancaires&nbsp;;</span></p>
                <p>Ces données sont collectées lorsque l'utilisateur effectue l'une des opérations suivantes sur le site&nbsp;:</p>
                <p ><span id="span_id_operations_collectes_donnees">- Lorsqu'un utilisateur fait une demande de devis pour son projet en remplissant le formulaire adéquat&nbsp;;<br/>- Lorsqu'un utilisateur fait une demande d'inscription en tant qu'entrepreneur pour recevoir des projets de clients en remplissant le formulaire adéquat&nbsp;;</span> </p>
                ...
                <p>Le responsable du traitement conservera dans ses systèmes informatiques du site et dans des conditions raisonnables de sécurité l'ensemble des données collectées pour une durée de&nbsp;: <span id="span_id_duree_conservation_donnees">- cookie d'analyse des visites: 5 ans&nbsp;;<br/>- données comptables: 10 ans&nbsp;;<br/>- données personnelles: 5 ans&nbsp;;</span>.</p>
                <p>La collecte et le traitement des données répondent aux finalités suivantes&nbsp;:</p>
                <p ><span id="span_id_finalite_traitement_donnees">- Traitement des demandes de devis des clients afin de les mettres en relation avec des entrepreneurs de notre réseau&nbsp;;<br/>- Traitement des demandes d'inscription des entrepreneurs afin de les mettre en relation avec les demandeurs de devis.</span></p>
                <p>Les traitements de données effectués sont fondés sur les bases légales suivantes&nbsp;:</p>
                <p ><span id="span_id_bases_legales">- L'utilisateur a expressément consenti au traitement&nbsp;;<br/>- Le traitement est nécessaire à la bonne exécution d'un contrat&nbsp;;</span></p>

                <p ><strong>B.</strong> TRANSMISSION DES DONNÉES A DES TIERS</p>

                <p>Les données à caractère personnel collectées par le site ne sont transmises à aucun tiers, et ne sont traitées que par l'éditeur du site. <br/></p>
                <p ><strong>C. </strong>HÉBERGEMENT DES DONNÉES</p>
                <p>Le site <span id="span_id_nom_du_site_internet">Renovation Facile</span> est hébergé par&nbsp;: <span id="span_id_denomination_sociale_de_l_hebergeur">Vercel Solutions LLC</span>, dont le siège est situé à l'adresse ci-après&nbsp;:</p>
                <p ><span id="span_id_siege_social_de_l_hebergeur">3001 Bridgeway Ste 178 Sausalito, CA, 94965-1408 United States</span></p>
                <p>L'hébergeur peut être contacté au numéro de téléphone suivant&nbsp;: <span id="span_id_telephone_de_l_hebergeur">+1 415.845.4001</span>. </p>
                <p>Les données collectées et traitées par le site sont exclusivement hébergées et traitées en France. </p>
                <p ><br/><strong>ARTICLE 4&nbsp;: RESPONSABLE DU TRAITEMENT DES DONNÉES </strong></p>

                <p ><strong>A. </strong>LE RESPONSABLE DU TRAITEMENT DES DONNÉES</p>
                <p>Le responsable du traitement des données à caractère personnel est&nbsp;: <span id="span_id_prenom_nom_responsable">Djamal DEHIMI, SARL RenovationFacile</span>. Il peut être contacté de la manière suivante&nbsp;:</p>
                <p ><span id="span_id_methode_contact_rtd">Le responsable du traitement des données peut être contacté par téléphone au 07.82.02.99.86, de 9h à 17 h, du lundi au vendredi.</span></p>
                <p>Le responsable du traitement des données est chargé de déterminer les finalités et les moyens mis au service du traitement des données à caractère personnel. <br/></p>
                <p ><strong>B. </strong>OBLIGATIONS DU RESPONSABLE DU TRAITEMENT DES DONNÉES</p>
                ...
                <p>Dans le cas où l'intégrité, la confidentialité ou la sécurité des données à caractère personnel de l'utilisateur est compromise, le responsable du traitement s'engage à informer l'utilisateur par tout moyen. <br/></p>
                <p ><strong>ARTICLE 5&nbsp;: DROITS DE L'UTILISATEUR </strong><br/></p>
                ...
                <p>Le responsable du traitement des données est tenu de répondre à l'utilisateur dans un délai de 30 (trente) jours maximum.<br/></p>
                <p ><strong>A.</strong> PRÉSENTATION DES DROITS DE L'UTILISATEUR EN MATIÈRE DE COLLECTE ET TRAITEMENT DE DONNÉES</p>
                <p><em>a. Droit d'accès, de rectification et droit à l'effacement</em></p>
                ...
                <p ><span id="span_id_procedure_acces_donnees">L'utilisateur doit envoyer un e-mail au responsable du traitement des données personnelles, en précisant l'objet de sa demande, à l'adresse e-mail de contact.</span> </p>
                ...
                <p ><span id="span_id_procedure_suppression_compte">L'utilisateur doit envoyer un e-mail au responsable du traitement en précisant son numéro d'espace personnel (numéro client). La demande sera traitée dans un délai de 10 jours ouvrés.</span><br/></p>
                ...
                <p ><span id="span_id_procedure_portabilite_donnees_personnelles">L'utilisateur doit faire une demande de portabilité de ses données personnelles auprès du responsable du traitement des données, en envoyant un e-mail à l'adresse prévue ci-dessus.</span></p>
                <p><em>c. Droit à la limitation et à l'opposition du traitement des données</em></p>
                ...
                <p ><span id="span_id_procedure_limitation_traitement">L'utilisateur doit faire une demande de limitation au traitement de ses données personnelles par e-mail auprès du responsable du traitement des données.</span><br/></p>
                ...
                <p><em>e. Droit de déterminer le sort des données après la mort</em></p>
                ...
                <p><em>f. Droit de saisir l'autorité de contrôle compétente</em></p>
                <p>Dans le cas où le responsable du traitement des données décide de ne pas répondre à la demande de l'utilisateur, et que l'utilisateur souhaite contester cette décision, ou, s'il pense qu'il est porté atteinte à l'un des droits énumérés ci-dessus, il est en droit de saisir la CNIL (Commission Nationale de l'Informatique et des Libertés, https://www.cnil.fr) ou tout juge compétent. <br/></p>
                <p ><span >B. </span>DONNÉES PERSONNELLES DES PERSONNES MINEURES</p>
                ...
                <p ><br/><strong>ARTICLE 6&nbsp;: UTILISATION DES FICHIERS "COOKIES"<br/></strong></p>
                ...
                <p ><span id="span_id_consentement_cookies">Veuillez cliquer sur le bouton "retirer le consentement". <br/>Veuillez vous rendre sur la page de paramétrage des cookies en cliquant ici.</span></p>
                ...
                <p ><span id="span_id_liste_cookies">- Cookie&nbsp;: Noogle, Emetteur&nbsp;: Contact.SAS, Finalité&nbsp;: analyse des habitudes de navigation. <br/>- Cookie&nbsp;: ContactMi, Emetteur&nbsp;: Contact.SAS, Finalité&nbsp;: sauvegarde des préférences.</span> </p>
                ...
                <p ><span id="span_id_tiers_cookies">- Google&nbsp;;<br/>- Facebook (Meta)&nbsp;;</span> </p>
                ...
                <p ><strong>ARTICLE 7&nbsp;: CONDITIONS DE MODIFICATION DE LA POLITIQUE DE CONFIDENTIALITÉ<br/></strong></p>
                <p>La présente politique de confidentialité peut être consultée à tout moment à l'adresse ci-après indiquée&nbsp;:</p>
                <p ><span id="span_id_adresse_politique_confidentialite">Renovationfacile.fr/politique-de-confidentialite</span></p>
                ...
                <p ><span id="span_id_modification_substantielle_moyen_information">Par notification "push" lors d'une visite de l'utilisateur&nbsp;;</span></p>

                <p>Il est porté à la connaissance de l'utilisateur que la dernière mise à jour de la présente politique de confidentialité est intervenue le&nbsp;: <span id="span_id_date_derniere_maj" class="encours">07/01/2022</span>.</p>
                <p><strong><br/>ARTICLE 8&nbsp;: <span>ACCEPTATION PAR L'UTILISATEUR DE LA POLITIQUE DE CONFIDENTIALITÉ</span><br/></strong></p>
                <p><span>En naviguant sur le site, l'utilisateur atteste avoir lu et compris la présente politique de confidentialité et en accepte les conditions, en ce qui concerne plus particulièrement la collecte et le traitement de ses données à caractère personnel.</span></p>
            </div>
            <br/>
        </div>
    )
